...
class BudgetLineitems extends Backbone.View
    ...
    addBudgetLineitem: (e) ->
        ...
        jsRoutes.controllers.Lineitems_rd.addBudgetLineitem().ajax
            data:
...
class BudgetLineitem extends Backbone.View
    ...
    editBudgetLineitem: ->
        ...
        task1BudgetInput = $("<input/>").css("width","100px").attr("id","task1Budget").attr("data-lineitem-id", @id).val(task1Budget).change ->
            ...
            jsRoutes.controllers.Lineitems_rd.updateLineitem(context.el.attr("data-lineitem-id")).ajax
                context: this
                data:
    ...
    recalculate: ->
        ...
        $("#budgetitems").children("tr").each (i,c) ->
            ...
            salecosttotal += parseFloat($(c).attr("data-sale"))
        for i of temp
