...
class Saleitems extends Backbone.View
    ...
    addSaleitem: (e) ->
        ...
        jsRoutes.controllers.Saleitems.addSaleitem().ajax
            data:
...
class Saleitem extends Backbone.View
    ...
    deleteSaleitem: (e) ->
        ...
        if (confirm('Are you sure?'))
            jsRoutes.controllers.Saleitems.deleteSaleitem(@id).ajax
                context: this
                success: ->
                    @el.remove()
                    @recalculate()
    ...
    updateSaleitem: (e) ->
        ...
        jsRoutes.controllers.Saleitems.updateSaleitem(@id).ajax
            context: this
            data:
                name: @name.val()
