...
public class MyUsernamePasswordAuthProvider
	...
	protected Call userUnverified(final UsernamePasswordAuthUser authUser) {
		return routes.Signup.unverified(User.findByAuthUserIdentity(authUser).id);
	}
	...
	protected Body getVerifyEmailMailingBody(final String token,
        ...
        return getVerifyEmailMailingBodyAfterSignup(token, User.findByAuthUserIdentity(user), ctx);
	}
	...
	public void sendPasswordResetMailing(final User user, final Context ctx) {
        ...
        Mailer.getDefaultMailer().sendMail(subject, body, getEmailName(user));
	}
