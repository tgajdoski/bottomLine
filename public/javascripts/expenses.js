...
$(document).ready(function() {
    ...
    $(function() {
        ...
        $( "#qbdatepicker" ).val($.datepicker.formatDate('yy-mm-dd', new Date()));
    });
    $(function() {
        $( "#startdisdatepicker" ).datepicker();
        $( "#startdisdatepicker" ).datepicker( "option", "dateFormat",'yy-mm-dd' );
        $( "#startdisdatepicker" ).val($.datepicker.formatDate('yy-mm-dd', new Date()));
    });
