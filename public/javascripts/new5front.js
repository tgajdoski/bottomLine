...
$(document).ready(function() {
    ...
    $( ".btn").click(function(){
        ...
        var verifiedSelect = $("#verifiedSelect  :selected").val();
     ...
     //    var managerid = $("#managerSelect").val();
        ...
        var subdivisionid = $("#subdivisionSelect").val();
            ...
            /* jsRoutes.controllers.Reports_rd.getnew2frontdata().ajax(
             {*/
                            type: "GET",
                            url: "/report/front/new5frontdata",
                            cache: false,
                  /*  jsRoutes.controllers.Reports_rd.getnew1frontdata().ajax(
                        {*/
                            data: {
                                jobid: jobidstring,
                                verifiedSelect: verifiedSelect,
                                markets: foo,
                                jobCategories: foo1,
        ...
        getTotals(foo, foo1, customersid, subdivisionid, verifiedSelect, jobidstring);
...
function getTotals( foo,foo1, customersid, subdivisionid,verifiedSelect, jobidstring ){
    /// baramem totalite vo dolniot del
    jQuery.ajax({
        type: "GET",
        url: "/report/front/new5frontdataTotal",
        cache: false,
        data: {
            jobid: jobidstring,
            verifiedSelect: verifiedSelect,
