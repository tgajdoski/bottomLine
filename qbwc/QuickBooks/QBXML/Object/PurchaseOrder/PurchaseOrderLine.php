...
{
	/**
	 * Create a new QuickBooks PurchaseOrder PurchaseOrderLine object
	 * 
	 * @param array $arr
	 */
	...
	public function setPurchaseTaxCodeName($name)
	{
		return $this->set('PurchaseTaxCodeRef FullName', $name);
	}
	
	public function setPurchaseTaxCodeListID($ListID)
	{
		return $this->set('PurchaseTaxCodeRef ListID', $ListID);
	}
	
	public function getPurchaseTaxCodeName()
	{
		return $this->get('PurchaseTaxCodeRef FullName');
	}
	
	public function getPurchaseTaxCodeListID()
	{
		return $this->get('PurchaseTaxCodeRef ListID');
	}
	
	public function setTaxable()
	{
		return $this->set('PurchaseTaxCodeRef FullName', QUICKBOOKS_TAXABLE);
	}
	
	public function setNonTaxable()
	{
		return $this->set('PurchaseTaxCodeRef FullName', QUICKBOOKS_NONTAXABLE);
	}
	
	public function getTaxable()
	{
		return $this->get('PurchaseTaxCodeRef FullName') == QUICKBOOKS_TAXABLE;
	}
