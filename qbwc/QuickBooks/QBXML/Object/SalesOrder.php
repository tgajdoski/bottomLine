...
class QuickBooks_QBXML_Object_SalesOrder extends QuickBooks_QBXML_Object
{
  ...
  public function getTransactionID()
  {
	...
	/**
	 * Set the transaction ID of the SalesOrder object
	 * 
	 * @param string $TxnID
	 * @return boolean
	 */
  ...
  public function getClassApplicationID()
  {
	...
	/**
	 * Alias of {@link QuickBooks_Object_SalesOrder::setTxnDate()}
	 */
	...
	/**
	 * Alias of {@link QuickBooks_Object_SalesOrder::getTxnDate()}
	 */
	...
	public function getSalesOrderLine($which)
	{
		$list = $this->getSalesOrderLines();
	...
	*/
	...
	/*
	public function setSalesOrderLine($i, 
	{
	...
	*/
	...
	public function addSalesOrderLine($obj)
	{
		...
		*/
		...
		return $this->set('SalesOrderLine', $lines);
	}
	
	public function setSalesOrderLine($i, $obj)
	{
		
	}
	
	public function setSalesOrderLineData($i, $key, $value)
	{
		$lines = $this->getSalesOrderLines();
		if (isset($lines[$i]))
		{
	...
	public function getSalesOrderLineData()
  {
